      ...
      case "warning":
        return (
          <span>
            ...
            This location has no Homepass within the selected radius. Try increasing the range or register as a potential customer.
          </span>
        );
      case "canceled":
    ...
    <div className="flex flex-row">
      <div className="flex flex-col space-y-3 py-2">
            <div className="flex justify-between items-start">
              <span
                className={cn(
                  `flex text-xs text-justify px-2 py-2 rounded-[5px] items-center gap-2`,
                  style.color,
                  style.bg,
                )}
              >
                <IconifyIcon icon={style.icons} className={cn("w-6 h-6 shrink-0", style.color)}/>
                {getMessage()}
              </span>
            </div>
          </div>
