...
const CustomDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent
        className={`max-w-2xl max-h-full  rounded-lg border border-zinc-200 shadow-xl top-10 left-1/2 -translate-x-1/2 translate-y-0 overflow-y-auto scrollbar-hidden-y ${className}`}
