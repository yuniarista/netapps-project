...
export default function OdpDataTable({ columns, handleModalOpen }) {
      ...
      {hasData ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center p-6 bg-slate-50/50">
          <div className="space-y-4 max-w-xs">
            <Label className="text-xl font-bold">No ODP Points Found</Label>
            <p className="text-sm text-muted-foreground">
              The final connection point is missing. Create an ODP to provide
              service ports for customer homepass connections.
            </p>
            <CustomButton
              variant="primary"
              size="lg"
