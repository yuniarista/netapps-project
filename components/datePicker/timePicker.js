...
export default function TimePicker({ value, onChange }) {
  ...
  return (
    <div className="flex h-[300px] bg-white border-l border-slate-100">
      <div className="flex flex-col w-[70px] border-r border-slate-50">
        <div className="text-xs tracking-wider text-muted-foreground font-bold py-3 text-center bg-white sticky top-0 z-10">
          Hours
        </div>
