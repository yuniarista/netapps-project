...
export const useHomepassState = (odpData) => {
  ...
  const [isCoverageModalOpen, setIsCoverageModalOpen] = useState(false); // Modal Peta

  const handleOpenCoverage = () => setIsCoverageModalOpen(true);
  const handleCloseCoverage = () => setIsCoverageModalOpen(false);
