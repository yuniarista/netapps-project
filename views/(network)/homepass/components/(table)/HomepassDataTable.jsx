      ...
      {hasData ? (
        <div className="px-4 space-y-2 py-2">
          <div className="w-full">
            <Label className="font-semibold text-sm">Homepass Data</Label>
          </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center p-6 bg-slate-50/50">
          <div className="space-y-4 max-w-xs">
            <Label className="text-xl font-bold">No Homepass IDs Found</Label>
            <p className="text-sm text-muted-foreground">
              Start mapping your coverage area. Add Homepass IDs to identify
              buildings and houses ready for installation.
            </p>
            <CustomButton
              variant="primary"
              size="lg"
