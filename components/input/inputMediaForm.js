...
export default function InputMediaForm({
  ...
  const renderPreview = () => {
    ...
    return (
      <div className="flex items-center gap-2 px-2 py-2 rounded border border-primary bg-muted w-40">
        <FileText className="w-5 h-5 text-muted-foreground truncate" />
      ...
      >
        {!file && (
          <div className="flex flex-col justify-center items-center space-y-2">
            ...
            <p className="text-base text-foreground font-medium">Upload BAA Document</p>
            <p className="text-sm font-sans font-normal">Click to browse or drag & drop - JPG, PNG, PDF, Max 15MB each</p>
          </div>
        )}
