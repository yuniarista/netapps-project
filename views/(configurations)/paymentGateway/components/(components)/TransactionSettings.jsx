...
import { Pencil, Globe, Clock, Building, CheckCircle2, Store, Server, KeyRound, Coins, Loader } from "lucide-react";
import IconifyIcon from "@/components/icon";

const TransactionSettings = ({ onEdit, isConnected = true }) => {
    const infoData = [
        {
            label: "Default expiry time (fallback)",
            value: "24 Hours",
            icon: Clock,
            hexColor: "#22c55e",
            hexBg: "#f0fdf4",
            ...
            <CardHeader className="flex flex-row items-start justify-between p-4 pb-2 space-y-0">
                <div className="space-y-1">
                    ...
                    <CardDescription className="text-sm text-muted-foreground">
                        Configure transaction behavior and customer options
                    </CardDescription>
                </div>
