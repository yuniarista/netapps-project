...
export default function FaqDataTable({
  ...
  const hasData = Array.isArray(data?.data) ? data?.data.length > 0 : false;
  ...
  return (
    <div className="flex flex-col h-screen">
      {hasData ? (
                ...
                startAdornment: (
                  <div className="w-full flex items-center space-x-4">
                    <Input
                      ...
                      className="max-w-xs"
                    />
                    <div className="flex flex-nowrap items-center p-2 gap-2 overflow-x-auto scrollbar-hidden-x">
                      <CustomButton
                        variant="outline"
                        size="sm"
        ...
        <div className="h-screen flex flex-col items-center justify-center text-center p-6 bg-slate-50/50">
          <div className="space-y-4 max-w-xs">
            <Label className="text-xl font-bold">No FAQ Data</Label>
            <p className="text-sm text-muted-foreground">
              You haven't created any FAQ yet. <br />
